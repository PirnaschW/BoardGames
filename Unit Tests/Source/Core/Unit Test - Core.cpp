...
namespace UnitTestCore
{
  ...
  public:
    ...
    TEST_METHOD(TestAction)
    {
      ...
      ActionP a1{ std::make_shared<ActionLift>(l1,CorePiece::WC) };
      ActionP a2{ std::make_shared<ActionJump>(l2,Piece::NoPiece) };
      ActionP a3{ std::make_shared<ActionDrop>(l3,CorePiece::WC) };
      ActionP a4{ std::make_shared<ActionLift>(l1,CorePiece::WC) };
      ActionP a5{ std::make_shared<ActionJump>(l2,Piece::NoPiece) };
      ActionP a6{ std::make_shared<ActionDrop>(l3,CorePiece::WC) };

      Assert::IsTrue(a1->GetLocation() == l1);
      Assert::IsTrue(a2->GetLocation() == l2);
      Assert::IsTrue(a3->GetLocation() == l3);
      Assert::IsTrue(a1->GetPiece() == CorePiece::WC);
      Assert::IsTrue(a2->GetPiece() == Piece::NoPiece);
      Assert::IsTrue(a3->GetPiece() == CorePiece::WC);
    ...
    TEST_METHOD(TestMoves)
    {
      ...
      ActionP a11{ std::make_shared<ActionLift>(l1,CorePiece::WC) };
      ActionP a12{ std::make_shared<ActionJump>(l2,Piece::NoPiece) };
      ActionP a13{ std::make_shared<ActionDrop>(l3,CorePiece::WC) };

      ActionP a21{ std::make_shared<ActionLift>(l1,CorePiece::WC) };
      ActionP a22{ std::make_shared<ActionDrop>(l3,CorePiece::WC) };

      ActionP a31{ std::make_shared<ActionLift>(l1,CorePiece::WC) };
      ActionP a32{ std::make_shared<ActionJump>(l2,Piece::NoPiece) };
      ActionP a33{ std::make_shared<ActionDrop>(l3,CorePiece::WC) };
    ...
    TEST_METHOD(TestEvaluateChainLengths)
    {
      ...
      { // create a test position and run test for white 1, 2, 3 ,4
        ...
        p.SetPiece(Location{ BoardPart::Main,7,7 }, CorePiece::WC);
        v = p.EvaluateChainLengths(3);
        ...
        p.SetPiece(Location{ BoardPart::Main,6,7 }, CorePiece::WC);
        v = p.EvaluateChainLengths(3);
        ...
        p.SetPiece(Location{ BoardPart::Main,8,7 }, CorePiece::WC);
        v = p.EvaluateChainLengths(3);
        ...
        p.SetPiece(Location{ BoardPart::Main,5,7 }, CorePiece::WC);
        v = p.EvaluateChainLengths(3);
        Assert::IsTrue(v == PositionValue(PositionValue::PValueType::Won));
        v = p.EvaluateChainLengths(4);
        Assert::IsTrue(v == PositionValue(PositionValue::PValueType::Won));
      ...
      { // create a test position and run test for white 1, black 1, white 2, black 2, 
        ...
        p.SetPiece(Location{ BoardPart::Main,7,7 }, CorePiece::WC);
        p.SetPiece(Location{ BoardPart::Main,6,7 }, CorePiece::BC);
        v = p.EvaluateChainLengths(3);
        ...
        p.SetPiece(Location{ BoardPart::Main,7,6 }, CorePiece::WC);
        v = p.EvaluateChainLengths(3);
        ...
        p.SetPiece(Location{ BoardPart::Main,6,6 }, CorePiece::BC);
        v = p.EvaluateChainLengths(3);
        Assert::IsTrue(v == PositionValue(0)); // symmetry!
        v = p.EvaluateChainLengths(4);
        Assert::IsTrue(v == PositionValue(0));
