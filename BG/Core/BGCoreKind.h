...
namespace BoardGamesCore
{
  ...
  public:
    ...
    virtual inline bool CanMove(const Piece& /*p*/, const Location& /*l*/, const MainPosition* /*pos*/) const noexcept { return true; }    // useful default implementation: this kind can move
    virtual inline bool CanTake(const Kind& /*k*/) const noexcept { return true; }                                                         // useful default implementation: this kind can take any other kind
    virtual inline bool CanDrop(const Piece& /*p*/, const Location& /*l*/, const MainPosition* /*pos*/) const noexcept { return false; }   // useful default implementation: this kind cannot drop
