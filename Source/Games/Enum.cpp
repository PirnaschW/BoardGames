...
namespace BoardGamesCore
{
  ...
  Game* CreateGame(const VariantChosen& v)
  {
    ...
    case IDR_GAMETYPE_MCHESS:     return new MassacreChess::MCGame        (v, Variants<class MassacreChess::MCGame       >::GetPieces(v), MassacreChess::Variants<class MassacreChess::MCGame       >::GetDimensions(v));
