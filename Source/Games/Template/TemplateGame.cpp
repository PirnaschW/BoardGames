...
namespace Template
{
  ...
  bool TemplateBoard::AddIfLegal(Moves& m, const Location& fr, const Location& to) const noexcept
  {
  ...
  PositionValue TemplateBoard::EvaluateStatically() const noexcept
  {
  ...
  const VariantList& TemplateGame::GetVariants() noexcept
  {
  ...
  const PieceMapP& TemplateGame::GetPieces() noexcept
  {
